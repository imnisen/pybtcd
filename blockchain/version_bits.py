...
class DeploymentChecker(ThresholdConditionChecker):
    def __init__(self, deployment, chain):
        """

        :param chaincfg.ConsensusDeployment deployment:
        :param chain:
        """
    ...
    # This is part of the thresholdConditionChecker interface implementation.
    def begin_time(self) -> int:
        return self.deployment.start_time
    ...
    # This is part of the thresholdConditionChecker interface implementation.
    def end_time(self) -> int:
        return self.deployment.expire_time
    ...
    # This is part of the thresholdConditionChecker interface implementation.
    def condition(self, node):
        condition_mask = 1 << self.deployment.bit_number

        version = node.version

        return (version & vbTopMask == vbTopBits) and (version & condition_mask != 0)
